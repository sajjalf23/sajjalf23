...
<svg xmlns="http://www.w3.org/2000/svg" width="960" height="141" class="large">
    <defs>
        <style/>
    </defs>
    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <small>estimation from 26.4mb of code in 2275 edited files across 725 commits</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="920" height="8">
                    ...
                    <rect mask="url(#languages-bar)" x="0" y="0" width="375.71179017540754" height="8" fill="#3572A5"/>
                    <rect mask="url(#languages-bar)" x="375.71179017540754" y="0" width="230.47309642983697" height="8" fill="#f34b7d"/>
                    <rect mask="url(#languages-bar)" x="606.1848866052445" y="0" width="163.32269334691708" height="8" fill="#178600"/>
                    <rect mask="url(#languages-bar)" x="769.5075799521617" y="0" width="56.65122807406095" height="8" fill="#663399"/>
                    <rect mask="url(#languages-bar)" x="826.1588080262226" y="0" width="53.09377214741318" height="8" fill="#f1e05a"/>
                    <rect mask="url(#languages-bar)" x="879.2525801736358" y="0" width="18.494695694542877" height="8" fill="#e38c00"/>
                    <rect mask="url(#languages-bar)" x="897.7472758681786" y="0" width="11.793026886959604" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="909.5403027551382" y="0" width="10.4596972448618" height="8" fill="#e34c26"/>
                </svg>
                <div class="row fill-width">
                    ...
                    <section>
                        ...
                        <div class="field language details">
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                    <path fill="#e38c00" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8z"/>
                                </svg>
                                TSQL
                            </div>
                            <small>
